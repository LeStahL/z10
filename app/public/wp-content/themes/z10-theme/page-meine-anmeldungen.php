...
<div class="container container--narrow page-section">
	...
	<div class="create-note">
		...
		<textarea class="new-note-body" placeholder="Schreibe hier deine Notiz"></textarea>
		<span class="submit-note">Notiz erstellen</span>
		<span class="note-limit-message">Du hast dein Limit erreicht. Entferne eine existierende Notiz, um Platz zu schaffen.</span>
	</div>
		...
		<?php
			...
			while($userNotes->have_posts()) {
				...
				<li data-id="<?php the_ID();?>">
					...
					<span class="delete-note"><i class="fa fa-trash-o" aria-hidden="true"></i> Entfernen</span>
